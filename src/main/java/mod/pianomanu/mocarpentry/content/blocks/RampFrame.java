...
public class RampFrame extends FrameBlock implements IWaterLoggable {
	...
	* x1 y1 z1 x2 y2 z2 */
	...
	protected void fillStateContainer(StateContainer.Builder<Block, BlockState> builder) {
		builder.add(FACING, HALF, SHAPE, WATERLOGGED, CONNECTED_LEFT, CONNECTED_RIGHT, BCBlockStateProperties.CONTAINS_BLOCK, LIGHT_LEVEL);
	}
