...
public class RegistrationHandler {
    ...
    public static final RegistryObject<TileEntityType<FrameBlockTile>> POST_STAIRS_FRAME_TILE = TILES.register("post_frame", () -> TileEntityType.Builder.create(FrameBlockTile::new, POST_FRAME.get()).build(null));
