...
public class ModelHelper {
     ...
     * the dimensions of the cuboid and the texture to apply and which face to render.
     ...
     * @param tintIndex only needed for tintable blocks like grass
     * @param north Shows north face ?
     * @param south Shows south face ?
     * @param east Shows east face ?
     * @param west Shows west face ?
     * @param up Shows top face ?
     * @param down Shows bottom face ?
	...
	public static List<BakedQuad> createCuboid(float xl, float xh, float yl, float yh, float zl, float zh, TextureAtlasSprite texture, int tintIndex,
        ...
        if (down) quads.add(createQuad(SWD, SED, NED, NWD, texture, 16-xl*16, 16-xh*16, 16-zl*16, 16-zh*16, tintIndex));
        ...
        if (south) quads.add(createQuad(SEU, SED, SWD, SWU, texture, 16-zh*16, 16-zl*16, 16-yh*16, 16-yl*16, tintIndex));
        return quads;
    }
	...
	/**
	 * Same as createCuboid but with values between 0 and 16 instead of between 0 and 1
	 */
	public static List<BakedQuad> createCuboid16(float xl, float xh, float yl, float yh, float zl, float zh, TextureAtlasSprite texture, int tintIndex,
			boolean north, boolean south, boolean east, boolean west, boolean up, boolean down) {
        return createCuboid(xl / 16f, xh / 16f, yl / 16f, yh / 16f, zl / 16f, zh / 16f, texture, tintIndex, north, south, east, west, up, down);
    }
	 ...
	 */
	public static List<BakedQuad> createCuboid16(float xl, float xh, float yl, float yh, float zl, float zh, TextureAtlasSprite texture, int tintIndex) {
        return createCuboid(xl / 16f, xh / 16f, yl / 16f, yh / 16f, zl / 16f, zh / 16f, texture, tintIndex);
    }
	
	/**
	 * Same as createCuboid but with values between 0 and 16 instead of between 0 and 1
	 */
	public static List<BakedQuad> createCuboid16(int xl, int xh, int yl, int yh, int zl, int zh, TextureAtlasSprite texture, int tintIndex,
			boolean north, boolean south, boolean east, boolean west, boolean up, boolean down) {
        return createCuboid(xl / 16f, xh / 16f, yl / 16f, yh / 16f, zl / 16f, zh / 16f, texture, tintIndex, north, south, east, west, up, down);
    }
